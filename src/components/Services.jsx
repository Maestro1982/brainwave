    ...
    <Section id='how-to-use'>
      <div className='container'>
        ...
        <div className='relative'>
          {/* Create a space with a border */}
          <div className='relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p20 xl:h-[46rem]'>
